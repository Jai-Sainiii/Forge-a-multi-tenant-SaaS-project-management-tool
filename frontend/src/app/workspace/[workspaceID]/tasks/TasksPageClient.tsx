              ...
              {loading ? (
                ...
                <tr>
                  ...
                  >
                    ...
                    <button 
                      onClick={() => setIsCreateTaskModalOpen(true)}
                      className="mt-4 px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md text-sm font-medium hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
                    >
                      Create Task
                    </button>
                  </td>
