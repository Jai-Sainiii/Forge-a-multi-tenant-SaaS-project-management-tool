...
export default function ActivityClient({
  ...
  const [tasks] = useState<any[]>(initialTasks);
  const [members] = useState<any[]>(initialMembers);
    ...
    <div className="px-8 py-6 max-w-[1200px] mx-auto min-h-screen">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <div className="space-y-6">
          ...
          {/* Quick tips Card */}
          <div className="bg-gradient-to-br from-[#0F0F10] to-[#1F1F24] border border-[#2F2F35] text-white rounded-xl p-5 shadow-sm">
