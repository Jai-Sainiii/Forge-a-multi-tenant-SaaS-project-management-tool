      ...
      <main>
              ...
              <div className="p-8 grid grid-cols-3 gap-6 min-h-[400px]">
                {["To Do", "In Progress", "Done"].map((col) => (
                  <div key={col} className="flex flex-col gap-4">
                    ...
                    <div
                      className={`p-4 rounded-lg border flex flex-col gap-3 ${col === "In Progress" ? "border-primary bg-primary/[0.02] dark:bg-primary/5" : "border-outline-variant dark:border-slate-700"}`}
                    >
                      <div
                        className={`h-2 rounded w-3/4 ${col === "In Progress" ? "bg-primary/20" : "bg-slate-100 dark:bg-slate-800"}`}
                      />
                      <div
                        className={`h-2 rounded w-1/2 ${col === "In Progress" ? "bg-primary/10" : "bg-slate-50 dark:bg-slate-700"}`}
                      />
                      <div className="flex justify-between items-center mt-2">
                        <div className="flex -space-x-1.5">
                          ...
                          {col === "In Progress" && (
                            <div className="w-5 h-5 rounded-full bg-primary/20 border border-white dark:border-slate-900" />
                          )}
                        </div>
                        <span
                          className={`text-[8px] px-1.5 py-0.5 rounded-full font-bold uppercase tracking-tighter ${col === "In Progress" ? "bg-primary text-white" : "bg-slate-200 dark:bg-slate-700 text-slate-500 dark:text-slate-400"}`}
                        >
        ...
        <section className="border-y border-outline-variant dark:border-slate-800 bg-white/30 dark:bg-slate-900/30 py-10">
          <div className="max-w-7xl mx-auto px-6 flex flex-col lg:flex-row items-center gap-10">
            ...
            <div className="flex flex-wrap justify-center lg:justify-between items-center gap-12 lg:flex-grow opacity-30 grayscale contrast-125">
              {["STARK", "LUMEN", "ACME", "GLOBEX", "OCP", "SOYLENT"].map(
                (logo) => (
                  <span
                    key={logo}
        ...
        <section id="product" className="max-w-7xl mx-auto px-6 py-32">
          <motion.div {...fadeInUp} className="text-center mb-20">
            <h2 className="text-4xl font-bold tracking-tight mb-4 text-slate-900 dark:text-white">
        ...
        <section className="bg-slate-50/50 dark:bg-slate-950/50 border-y border-outline-variant dark:border-slate-800">
          <div className="max-w-7xl mx-auto px-6 py-32 flex flex-col gap-32">
            {[
              ...
              >
                <div
                  className={`flex flex-col gap-6 ${block.reverse ? "lg:order-2" : ""}`}
                >
                ...
                <div
                  className={`border border-outline-variant dark:border-slate-800 rounded-2xl bg-white dark:bg-slate-900 p-3 shadow-xl shadow-slate-200/40 dark:shadow-black/30 ${block.reverse ? "lg:order-1" : ""}`}
                >
                  <img
                    src={block.img}
                    alt={block.title}
